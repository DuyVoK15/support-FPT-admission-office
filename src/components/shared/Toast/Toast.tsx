...
const Toast: React.FC<Props> = React.forwardRef(
  ({ duration = 400, onHide }, ref) => {
    ...
    const timer = useRef<NodeJS.Timeout | null>(null); // Đặt kiểu dữ liệu của timer.current
    ...
    function generateImage() {
      if (config?.type === 'success') {
        return require('../../../assets/Images/ic_success.png');
      } else if (config?.type === 'error') {
        return require('../../../assets/Images/ic_error.png');
      } else {
        return require('../../../assets/Images/ic_info.png');
      }
    }
